...
public:
    ...
    */
    ...
    Instant(const std::chrono::time_point&);


    /*
     * Construct an instant from an SFML Time instance
     * Effectively the same as the Similar factory Method
     */
    Instant(const sf::Time&);
    ...
    */
    ...
    /*
     * Obtains an Instant from a given STL time_point
     */
    static Instant fromChronoTimePoint(const std::chrono::time_point&);

    /*
     * Obtains an Instant from a SFML Time
     */
    static Instant fromSFMLTime(const sf::Time&);
    ...
    */
    ...
    /*
     * Converts This to an STL time_point.
     */
    std::chrono::time_point toTimePoint()const;

    /*
     * Converts this Instant to an SFML Time
     * Note that this Method will reduce the resolution of the Resultant,
     * as SFML Time records only to microseconds.
     */
    sf::Time toSFMLTime()const;
};

DataOutputStream& operator<<(DataOutputStream&,const Instant&);
DataInputStream& operator>>(DataInputStream&,Instant&);
...
DataOutputStream& operator<<(DataOutputStream&,const Duration&);
DataInputStream& operator>>(DataInputStream&,Duration&);
